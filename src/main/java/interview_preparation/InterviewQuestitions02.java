...
public class InterviewQuestitions02 {
    ...
    Methods in "interface" are definitely "public"
            ...
            Variables may or may not be "final" in abstract class because of that it is not
...
4) Class "extends" Class, Interface "extends" Interface, Class "implements" Interface, Interface
"cannot be the child" of a Class*/
